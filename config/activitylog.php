...
use App\ActivityLog\AuditLogAction;
...
return [
     ...
     * The App\ActivityLog\AuditLogAction redacts these (and anything matching
     * config/audit.php `redacted_attributes`) as a final backstop as well.
     */
     ...
     */
    'actions' => [
        'log_activity' => AuditLogAction::class,
